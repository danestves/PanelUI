...
discussions, and any other channel used by the project — and also applies when an individual is
...
- Use GitHub's [private reporting form](https://github.com/contact/report-abuse) to report abuse
  or harassment directly to GitHub, which can act across the platform.
- For conduct specific to this repository, open a report from the repository's **Security** tab
  (*Report a vulnerability* accepts private reports and is visible only to the maintainers), or
  contact the maintainer through their GitHub profile.

Please do not report a Code of Conduct concern in a public issue or discussion. Doing so exposes
the reporter, and it rarely helps resolve the situation.
