...
The focused pad also exposes Undo, Redo and Clear as screen-reader actions when each action is available. Its value is announced as empty or complete, and clearing announces the resulting empty state.
