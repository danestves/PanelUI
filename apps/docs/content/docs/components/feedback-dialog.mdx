...
Closing on success is the caller's too. The dialog cannot know whether the send finished, and one that closed on the press would be gone before it found out.
