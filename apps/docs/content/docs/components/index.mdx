---
title: Components
description: Every component module in PanelUI, by what it is for — 116 component modules, each with its anatomy, props and variants.
---

All 116 component modules, grouped by the job they do. Every page covers the anatomy, every prop and every variant, read straight from the library's TypeScript so it cannot drift from the code.
...
<Cards>
  ...
  <Card title="ProgressButton" href="/docs/components/progress-button">
...
<Cards>
  ...
  <Card title="SearchBar" href="/docs/components/search-bar">
  ...
  <Card title="ThemeSelector" href="/docs/components/theme-selector">
...
<Cards>
  ...
  <Card title="Splitter" href="/docs/components/splitter">
    Panes that share a container, with a seam between them you can drag.
  </Card>
  <Card title="SplitView" href="/docs/components/split-view">
...
<Cards>
  ...
  <Card title="Planner" href="/docs/components/planner">
...
<Cards>
  ...
  <Card title="LiveLineChart" href="/docs/charts/live-line-chart">
  ...
  <Card title="Plot" href="/docs/charts/plot">
    A chart you assemble out of its marks.
  </Card>
  <Card title="PolarAreaChart" href="/docs/charts/polar-area-chart">
  ...
  <Card title="WaterfallChart" href="/docs/charts/waterfall-chart">
...
<Cards>
  ...
  <Card title="Meter" href="/docs/components/meter">
...
<Cards>
  <Card title="aiInput" href="/docs/ai-components/ai-input">
