---
title: Components
description: Every component in PanelUI, by what it is for — 101 of them, each with its anatomy, props and variants.
---

All 101 components, grouped by the job they do. Every page covers the anatomy, every prop and every variant, read straight from the library's TypeScript so it cannot drift from the code.
...
<Cards>
  ...
  <Card title="SelectionMode" href="/docs/components/selection-mode">
    Pick several rows out of a list, with a count and a bar of actions.
  </Card>
