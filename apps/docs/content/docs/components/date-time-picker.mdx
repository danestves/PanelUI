...
<PreviewVideo
  src="/previews/date-time-picker.mp4"
  poster="/previews/date-time-picker-poster.jpg"
  alt="The DateTimePicker component, running in the example app."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/date-time-picker.mp4"
  poster="/previews/date-time-picker-poster.jpg"
  alt="DateTimePicker — One value, filled in from either end."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/date-time-picker-where-the-panel-goes.mp4"
  poster="/previews/date-time-picker-where-the-panel-goes-poster.jpg"
  alt="DateTimePicker — Where the panel goes."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/date-time-picker-which-face-the-time-is-picked-on.mp4"
  poster="/previews/date-time-picker-which-face-the-time-is-picked-on-poster.jpg"
  alt="DateTimePicker — Which face the time is picked on."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/date-time-picker-bounding-it-on-both-axes.mp4"
  poster="/previews/date-time-picker-bounding-it-on-both-axes-poster.jpg"
  alt="DateTimePicker — Bounding it on both axes."
  width={720}
  height={1560}
/>
