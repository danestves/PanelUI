...
<Preview
  src="/previews/slide-button-sizes-and-variants.jpg"
  alt="Three slide buttons stacked on a dark screen, labelled Small, Medium and Large. Each is a pill-shaped rail with a wider pill-shaped handle resting at its left end, a chevron centred in the handle, and the label centred in the rail. The handles grow with the size while the rails stay the same width."
  width={1179}
  height={597}
  caption="The handle grows with the size; the rail's height goes with it."
/>
