...
<SlideButton size="lg" variant="secondary" fullWidth onComplete={go}>
  <SlideButton.Label>Large, secondary</SlideButton.Label>
</SlideButton>
```
...
```tsx
<SlideButton variant="primary">…</SlideButton>
