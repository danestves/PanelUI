...
```tsx
import { SearchBar, Text, PlusIcon } from 'panelui-native';
...
**Types:** `SearchBarProps`, `SearchBarItemProps`, `SearchBarSectionProps`, `SearchBarStatusProps`, `SearchBarPanelMode`, `SearchBarPanelPlacement`
