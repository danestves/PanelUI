---
title: SplitView
description: Two stacked panes whose seam settles on one of a few named heights.
status: new
---
...
```tsx
import { SplitView, ScrollView, Text, View } from 'panelui-native';
```
