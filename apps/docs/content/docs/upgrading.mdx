...
| -------------------- | -------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `panelui-native`     | `0.69.0` | [npm](https://www.npmjs.com/package/panelui-native/v/0.69.0)    | [package.json](https://github.com/panel-ui/PanelUI/blob/main/packages/panelui/package.json)            |
| `panelui-cli`        | `0.5.0`  | [npm](https://www.npmjs.com/package/panelui-cli/v/0.5.0)        | [package.json](https://github.com/panel-ui/PanelUI/blob/main/packages/cli/package.json)                |
| `create-panelui-app` | `0.2.1`  | [npm](https://www.npmjs.com/package/create-panelui-app/v/0.2.1) | [package.json](https://github.com/panel-ui/PanelUI/blob/main/packages/create-panelui-app/package.json) |
