...
| `panelui-cli`        | `0.6.1`  | [npm](https://www.npmjs.com/package/panelui-cli/v/0.6.1)        | [package.json](https://github.com/panel-ui/PanelUI/blob/main/packages/cli/package.json)                |
