...
<PreviewVideo
  src="/previews/treemap-chart.mp4"
  poster="/previews/treemap-chart-poster.jpg"
  alt="The TreemapChart component, running in the example app."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/treemap-chart-basic.mp4"
  poster="/previews/treemap-chart-basic-poster.jpg"
  alt="TreemapChart — Basic."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/treemap-chart-long-tail.mp4"
  poster="/previews/treemap-chart-long-tail-poster.jpg"
  alt="TreemapChart — Long tail."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/treemap-chart-selection.mp4"
  poster="/previews/treemap-chart-selection-poster.jpg"
  alt="TreemapChart — Selection."
  width={720}
  height={1560}
/>
...
**Values:** `TreemapChart`, `useTreemapChart`, `squarifyLayout`

**Types:** `TreemapChartProps`, `TreemapChartHandle`, `TreemapChartStatus`, `TreemapDatum`, `TreemapTile`, `TreemapRect`, `TreemapChartTilesProps`, `TreemapChartLabelsProps`, `TreemapChartTooltipProps`, `TreemapChartLegendProps`, `TreemapChartHeaderProps`, `TreemapChartSkeletonProps`
