...
<PreviewVideo
  src="/previews/funnel-chart.mp4"
  poster="/previews/funnel-chart-poster.jpg"
  alt="The FunnelChart component, running in the example app."
  width={720}
  height={1560}
/>
...
**Values:** `FunnelChart`, `useFunnelChart`

**Types:** `FunnelChartProps`, `FunnelChartHandle`, `FunnelChartHeaderProps`, `FunnelChartStagesProps`, `FunnelChartLabelsProps`, `FunnelChartLegendProps`, `FunnelChartSkeletonProps`, `FunnelChartStatus`, `FunnelDatum`, `FunnelEdges`, `FunnelLegendLayout`, `FunnelShare`
