...
| --- | --- | --- | --- |
| `className` | `string` | — |  |
| `data` | `LiveLinePoint[]` | — | The readings so far. Invalid values are dropped and timestamps are ordered. |
| `window` | `number` | — | How much time the plot spans, in seconds. Invalid values use 30. |
