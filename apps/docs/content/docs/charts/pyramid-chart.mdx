...
<PreviewVideo
  src="/previews/pyramid-chart.mp4"
  poster="/previews/pyramid-chart-poster.jpg"
  alt="PyramidChart — two series mirrored about a centre, on one shared scale."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/pyramid-chart-two-wings.mp4"
  poster="/previews/pyramid-chart-two-wings-poster.jpg"
  alt="PyramidChart — Two wings on one scale."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/pyramid-chart-population.mp4"
  poster="/previews/pyramid-chart-population-poster.jpg"
  alt="PyramidChart — Names between the wings, or down the left."
  width={720}
  height={1560}
/>
