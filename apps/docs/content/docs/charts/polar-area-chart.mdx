...
**Values:** `PolarAreaChart`, `usePolarAreaChart`

**Types:** `PolarAreaChartProps`, `PolarAreaChartHandle`, `PolarAreaChartHeaderProps`, `PolarAreaChartGridProps`, `PolarAreaChartWedgesProps`, `PolarAreaChartLabelsProps`, `PolarAreaChartTooltipProps`, `PolarAreaChartLegendProps`, `PolarAreaChartSkeletonProps`, `PolarAreaChartStatus`, `PolarAreaScale`, `PolarAreaDatum`
