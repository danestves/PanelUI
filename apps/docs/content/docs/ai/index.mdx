...
<Callout type="warn">
  **Beta.** These pages describe patterns rather than a stable API surface, and
  they move with the AI SDK.
</Callout>

Five of the patterns that were once only described here now ship as components:
[Reasoning](/docs/ai-components/reasoning), [Sources](/docs/ai-components/sources),
[Task](/docs/ai-components/task), [CodeBlock](/docs/ai-components/code-block) and
[Plan](/docs/ai-components/plan). None of them depends on the AI SDK — their props
...
| [`Shimmer`](/docs/ai-components/shimmer) | The thinking state before the first token |
