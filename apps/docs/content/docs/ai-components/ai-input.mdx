...
<PreviewVideo
  src="/previews/ai-input.mp4"
  poster="/previews/ai-input-poster.jpg"
  alt="The AIInput component, running in the example app."
  width={720}
  height={1560}
/>
...
<Preview
  src="/previews/ai-input-growing-and-then-scrolling.jpg"
  alt="AIInput — Growing, and then scrolling."
  width={1179}
  height={538}
/>
...
<Preview
  src="/previews/ai-input-on-one-line.jpg"
  alt="AIInput — On one line."
  width={1179}
  height={251}
/>
...
The platform is given text, never elements: a hosted view inside a labelled native button has no width anything can resolve. A pill's `detail` goes over as part of the label, so a handed-over pill is one label in one weight rather than a value and a quieter one beside it. An `indicator` is an element and cannot go at all — name the glyph with `indicatorSymbol` and the platform draws it from its own symbol set.

<Preview
  src="/previews/ai-input-the-platform-s-own-controls.jpg"
  alt="AIInput — The platform's own controls."
  width={1179}
  height={457}
/>
...
<PreviewVideo
  src="/previews/ai-input-one-button-three-jobs.mp4"
  poster="/previews/ai-input-one-button-three-jobs-poster.jpg"
  alt="AIInput — One button, three jobs."
  width={720}
  height={1560}
/>
...
<PreviewVideo
  src="/previews/ai-input-recording-without-a-recorder.mp4"
  poster="/previews/ai-input-recording-without-a-recorder-poster.jpg"
  alt="AIInput — Recording, without a recorder."
  width={720}
  height={1560}
/>
...
| `native` | `boolean` | — | Draw the two decisions as the platform's own buttons. |
