...
```tsx
{open && <Dialog open><Dialog.Content>…</Dialog.Content></Dialog>}  // wrong

<Dialog open={open} onOpenChange={setOpen}>                        // right
  <Dialog.Content>…</Dialog.Content>
</Dialog>
```

Overlays mount lazily and unmount themselves *after* the exit animation. Ripping the tree out
